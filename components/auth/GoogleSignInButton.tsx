function GoogleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden>
      ...
      <path
        fill="#4CAF50"
        d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238C29.211 35.091 26.715 36 24 36c-5.048 0-9.447-3.217-11.037-7.686l-6.543 5.038C9.505 39.556 16.227 44 24 44z"
      />
      <path
        fill="#1976D2"
...
export function GoogleSignInButton({
  ...
  label?: string;
  /** path ภายในที่จะกลับไปหลังล็อกอิน (เช่น /api/pos/handoff?…) — server ตรวจซ้ำด้วย safeReturnTo */
  next?: string;
}) {
  const href = next && next !== "/home" ? `/api/auth/google?next=${encodeURIComponent(next)}` : "/api/auth/google";
  return (
    <a
      href={href}
